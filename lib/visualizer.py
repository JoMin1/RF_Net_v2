...
class Visualizer():
    ...
    ##
    def print_current_performance(self, performance, recon_best, feat_best, adv, best):
        ...
        message += '     max recon: %.3f,   max feat: %.3f,   max norm AUC : %.3f    max AUC: %.3f' % (recon_best, feat_best, adv, best)
