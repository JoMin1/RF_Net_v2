...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--load_weights', help='Load the pretrained weights')
        ...
        ##
        # Train
        self.parser.add_argument('--save_result', type=bool, default=False, help='to save test result')
        self.parser.add_argument('--num_sample', type=int, default=0, help='to choose samples in #')
        self.parser.add_argument('--random_sample', type=int, default=0, help='to choose samples in random')
